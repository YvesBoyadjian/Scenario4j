...
import jsceneviewerglfw.GLCanvas;
import jsceneviewerglfw.GLData;
import jsceneviewerglfw.KeyEvent;
import jsceneviewerglfw.KeyListener;
import jsceneviewerglfw.Listener;
import jsceneviewerglfw.MouseEvent;
import jsceneviewerglfw.MouseListener;
import jsceneviewerglfw.MouseMoveListener;
import jsceneviewerglfw.MouseTrackListener;
import jsceneviewerglfw.MouseWheelListener;
import jsceneviewerglfw.PaintEvent;
import jsceneviewerglfw.PaintListener;
...
//        }    	
    ...
    public SbVec2s getGlxSize() {
        if (mainWidget != null) {
            ...
            return new SbVec2s ((short)size.getX(), (short)size.getY());
        } else {
    ...
    protected double getGlxDevicePixelRatio()
  {
    ...
    public void resizeCB() {
		Rectangle bounds = mainWidget.getBounds();
		float fAspect = (float) bounds.getWidth() / (float) bounds.getHeight();
