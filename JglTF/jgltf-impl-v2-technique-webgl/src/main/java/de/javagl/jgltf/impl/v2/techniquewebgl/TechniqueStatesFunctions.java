    ...
    extends GlTFProperty
{
    ...
    public void setBlendColor(float[] blendColor) {
        ...
        for (float blendColorElement: blendColor) {
            if (blendColorElement > 1.0D) {
                throw new IllegalArgumentException("blendColorElement > 1.0");
            }
            if (blendColorElement< 0.0D) {
                throw new IllegalArgumentException("blendColorElement < 0.0");
            }
        }
        this.blendColor = blendColor;
    }
    ...
    public void setDepthRange(float[] depthRange) {
        ...
        for (float depthRangeElement: depthRange) {
            if (depthRangeElement > 1.0D) {
                throw new IllegalArgumentException("depthRangeElement > 1.0");
            }
            if (depthRangeElement< 0.0D) {
                throw new IllegalArgumentException("depthRangeElement < 0.0");
            }
        }
        this.depthRange = depthRange;
    }
