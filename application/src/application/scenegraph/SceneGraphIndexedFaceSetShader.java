...
//		SbVec2s s3 = new SbVec2s((short)max3,(short)max3);
		...
		loadPolyline("application/ressource/PathToTheSeals1.2.poly");
		collectibleFamilies.add(new MushroomsFamily(this, getPolylinePoints("PathToTheSeals1.2.poly"), program2));
